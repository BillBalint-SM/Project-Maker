...
| `COMM-01` | Send controlled customer communication | versioned interview handoff plus authored, previewed and optionally referenced customer follow-up ping delivery; Claude Markdown is never sent to customers | [operations handoff](operations-handoff.md), [follow-up routes](../apps/api/src/follow-ups/follow-up.controller.ts) |
