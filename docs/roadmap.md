...
| --- | --- | --- | --- |
| `INTAKE-04` | Complete discovery-follow-up management | `INTAKE-04.1` is delivered; edit, resolve, source linkage, answer/decision, and scoring behavior remain planned. Does not replace customer email scheduling or project lifecycle. | [requirements](../.planning/REQUIREMENTS.md); depends on project and intake data |
