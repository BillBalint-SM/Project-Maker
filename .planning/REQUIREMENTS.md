...
- [ ] **ATTACH-01:** Authenticated employees can upload and download governed Question Bank reference files and Project work attachments on Initial Intake checklist snapshots and Discovery follow-ups without rewriting retained history or retaining Customer inbound attachment content. Implementation may use synthetic identity for verification, but production activation depends on `SEC-01` employee authorization, CSRF protection, and rate limiting.
