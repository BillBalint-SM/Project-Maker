...
- [x] G3: All web component tests pass after the two leaves compose.
  ...
  EVIDENCE: (node:34940) ExperimentalWarning: localStorage is not available because --localstorage-file was not provided. | (Use `node --trace-warnings ...` to show where the warning was created)
...
- [x] G4: The Angular application typechecks and production-builds without budget regression.
  ...
  EVIDENCE: ▲ [WARNING] src/app/app.component.scss exceeded maximum budget. Budget 4.00 kB was not met by 3.51 kB with a total of 7.51 kB. | ▲ [WARNING] src/app/settings/question-bank.page.scss exceeded maximum b
